@section('title', 'Riwayat DCU | Driver')
                        ...
                        <tbody>
                            @forelse ($dcurecords as $index => $record)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('driver.dcu.pdf', $record->id) }}" class="btn btn-sm btn-info"
                                            target="_blank">
                            ...
                            @empty
                                <tr>
                                    <td colspan="11" class="text-center">Tidak ada data riwayat DCU.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
