...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('kai/assets/css/custom.css') }}" /> {{-- CSS Kustom --}}
        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                <div class="logo-header" data-background-color="dark">
                    <a href="{{ route('managerarea.dashboard') }}" class="logo">
                        <img src="{{ asset('kai/assets/img/kaiadmin/pgncom-logo.png') }}" alt="navbar brand"
                            class="navbar-brand sidebar-brand"> {{-- Gunakan class sidebar-brand --}}
                    </a>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        <li class="nav-item {{ Request::is('managerarea/dashboard') ? 'active' : '' }}">
                            <a href="{{ route('managerarea.dashboard') }}" aria-expanded="false">
                                <i class="fas fa-home"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>

                        <li class="nav-item {{ Request::is('managerarea/perjalanan*') ? 'active' : '' }}">
                            <a data-bs-toggle="collapse" href="#perjalanan"
                                class="{{ Request::is('managerarea/perjalanan*') ? '' : 'collapsed' }}"
                                aria-expanded="{{ Request::is('managerarea/perjalanan*') ? 'true' : 'false' }}">
                                <i class="fa-solid fa-map-location-dot"></i>
                                <p>Perjalanan</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse {{ Request::is('managerarea/perjalanan*') ? 'show' : '' }}"
                                id="perjalanan">
                                <ul class="nav nav-collapse">
                                    <li class="{{ Request::is('managerarea/persetujuan') ? 'active' : '' }}">
                                        <a href="{{ route('managerarea.persetujuan') }}">
                                            <span class="sub-item">Persetujuan Perjalanan</span>
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('managerarea/history') ? 'active' : '' }}">
                                        <a href="{{ route('managerarea.history') }}">
                        ...
                        <li class="nav-item {{ Request::is('managerarea/kendaraan*') ? 'active' : '' }}">
                            <a href="{{ route('managerarea.kendaraan') }}">
                                            ...
                                            <div class="notif-center">
                                                @auth
                                                    @forelse(auth()->user()->notifications as $notification)
                                                        <a href="{{ route('managerarea.persetujuan', $notification->data['perjalanan_id']) }}"
