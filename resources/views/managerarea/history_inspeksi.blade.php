        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('managerarea.kendaraan.history', $kendaraan->id) }}"
                            ...
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-2 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('managerarea.kendaraan.history', $kendaraan->id) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('managerarea.showinspeksi', $inspeksi->id) }}"
