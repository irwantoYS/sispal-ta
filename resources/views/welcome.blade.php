                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-sm-12">
                                <img src="{{ asset('storage/images/Carousel-2.webp') }}" class="d-block w-100" alt="...">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container align-items-center ms-auto">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('storage/images/STAF 1.webp') }}" alt=""
                        ...
                        <div class="team-text">
                            ...
                            <div class="bg-primary">
                                <a class="btn btn-square mx-1" href="https://web.facebook.com/pgncom.id"
                                    target="blank">
                                ...
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/pgncom_id/"
                                    target="blank">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('storage/images/STAF 2.jpg') }}" alt=""
                                style="width: 400px; height: 400px;">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('storage/images/STAF 3.jpg') }}" alt=""
                                style="width: 400px; height: 400px;">
                            
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold text-center mb-0">Pengemudi Dengan
                                    Nol Pelanggaran Lalu Lintas</h5>
                                </div>
                            <div class="bg-primary">
                                <a class="btn btn-square mx-1"
                                    href="https://web.facebook.com/pgncom.id" target="blank">
                                    <i class="fab fa-facebook-f"></i>
                                    </a>
                                <a class="btn btn-square mx-1"
                                    href="https://twitter.com/pgncom_id" target="blank">
                                    <i class="fab fa-twitter"></i>
                                    </a>
                                <a class="btn btn-square mx-1"
                                    href="https://www.instagram.com/pgncom_id/" target="blank">
                                    <i class="fab fa-instagram"></i>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                    ...
                    <ul class="fa-ul" style="margin-left: 1.65em;">
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-home"></i></span><span
                                class="ms-2">Jl. Sam Ratulangi No.15 Penegahan Raya, Kedaton, Bandar Lampung
                                35112</span>
                            </li>
                        <li class="mb-3">
                    ...
                    <div class="mt-4 align-center">
                        <a type="button"
                            class="btn rounded-circle btn-floating btn-light btn-lg mx-2"
