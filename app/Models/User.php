 ...
 * @property string $status // Deklarasi untuk status, asumsikan tipe string
 * @property string|null $remember_token
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection<int, LaporanPerjalanan> $perjalanan
 * @property-read int|null $perjalanan_count
